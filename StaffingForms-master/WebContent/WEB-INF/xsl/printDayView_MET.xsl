...
<xsl:stylesheet version="1.0"
 ...
 <xsl:attribute-set name="cell.span7TopLeftRightBorder">
...
<xsl:attribute-set name="cell.span7TopBorder">
	<xsl:attribute name="number-columns-spanned">7</xsl:attribute>
	<xsl:attribute name="padding-left">0.5mm</xsl:attribute>
	<xsl:attribute name="padding-right">0.5mm</xsl:attribute>
	<xsl:attribute name="border-style">solid</xsl:attribute>
...
<xsl:attribute-set name="cell.span7LeftRightBorder">
	<xsl:attribute name="number-columns-spanned">7</xsl:attribute>
	<xsl:attribute name="padding-left">0.5mm</xsl:attribute>
	<xsl:attribute name="padding-right">0.5mm</xsl:attribute>
	<xsl:attribute name="border-style">solid</xsl:attribute>
...
<xsl:attribute-set name="cell.span7BottomLeftRightBorder">
	<xsl:attribute name="number-columns-spanned">7</xsl:attribute>
	<xsl:attribute name="padding-left">0.5mm</xsl:attribute>
	<xsl:attribute name="padding-right">0.5mm</xsl:attribute>
	<xsl:attribute name="border-style">solid</xsl:attribute>
	...
	<fo:table table-layout="fixed" width="100%" >
		...
		<fo:table-header>
			<fo:table-row height="8mm">
				<fo:table-cell xsl:use-attribute-sets="cell.span7TopLeftRightBorder">
					<fo:block xsl:use-attribute-sets="block.titleBigLabel">Day View</fo:block>
				</fo:table-cell>
			</fo:table-row>
			<fo:table-row height="4mm">
				<fo:table-cell xsl:use-attribute-sets="cell.span7LeftRightBorder">
			...
			<fo:table-row height="5mm">
				<fo:table-cell xsl:use-attribute-sets="cell.span7BottomLeftRightBorder">
		...
		<fo:table-body>
	       ...
	       <xsl:apply-templates select="//timeSlot">
  			...
  			<fo:table-row height="1mm">
				<fo:table-cell xsl:use-attribute-sets="cell.span7TopBorder">
					<fo:block></fo:block>
				</fo:table-cell>
			</fo:table-row>
    ...
    <fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlotTop">
        <fo:block xsl:use-attribute-sets="block.boxNumberTop"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberTop">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name1/store"/></fo:block>
		  </fo:table-cell>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberTop">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name2/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameTopCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name3/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberTopRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name3/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>
	...
	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name4/store"/></fo:block>
		  </fo:table-cell>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name5/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name6/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name6/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>
	 </xsl:if>			  
	...
	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name7/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name8/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name8/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name9/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name9/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>	 
	 </xsl:if>			  
 	...
 	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name10/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name11/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name11/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name12/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name12/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>
	 </xsl:if>			  
	...
	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name13/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name14/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name14/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name15/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name15/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>	 
	 </xsl:if>			  
	...
	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name16/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name17/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name17/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name18/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name18/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>	 
	 </xsl:if>			  
	...
	<fo:table-row height="5mm">
      <fo:table-cell xsl:use-attribute-sets="cell.timeSlot">
        <fo:block xsl:use-attribute-sets="block.boxNumber"><xsl:value-of select="time"/></fo:block>
		  ...
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name19/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name20/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumber">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name20/store"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.nameCenter">
			<fo:block xsl:use-attribute-sets="block.name"><xsl:value-of select="name21/name"/></fo:block>
		  </fo:table-cell>
		  <fo:table-cell xsl:use-attribute-sets="cell.storeNumberRight">
			<fo:block xsl:use-attribute-sets="block.storeNumber"><xsl:value-of select="name21/store"/></fo:block>
		  </fo:table-cell>
     </fo:table-row>	 
	 </xsl:if>			  
